export const RightLights: Record<number, string> = {
...
export const LeftLights: Record<number, string> = {
...
export const RearLights: Record<number, string> = {
...
export const LightBindingsRear: Record<number, string[]> = {
  0: [RearLights[7]],
